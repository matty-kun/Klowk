        ...
        <Animated.View style={{ transform: [{ translateY: slideAnim }] }}>
          ...
          >
            ...
            >
              {({ pressed }) => (
                <View
                  className={`flex-row items-center justify-center py-3.5 px-1 rounded-2xl ${pressed ? "bg-gray-50 dark:bg-zinc-800" : ""}`}
                >
                  <Edit2 size={20} color={isDark ? "#e5e7eb" : "#121212"} />
                  <Text className="text-base font-bold text-klowk-black dark:text-white ml-4">
                    Edit details
                  </Text>
                </View>
              )}
            ...
            >
              {({ pressed }) => (
                <View
                  className={`flex-row items-center justify-center py-3.5 px-1 rounded-2xl ${pressed ? "bg-red-50 dark:bg-red-900/10" : ""}`}
                >
                  <Trash2 size={20} color="#ef4444" />
                  <Text className="text-base font-bold text-red-500 ml-4">
                    Delete forever
                  </Text>
                </View>
              )}
            ...
            >
              {({ pressed }) => (
                <View
                  className={`items-center justify-center py-3.5 rounded-2xl ${pressed ? "bg-gray-50 dark:bg-zinc-800" : ""}`}
                >
                  <Text className="text-base font-bold text-gray-400 dark:text-zinc-600">
                    Cancel
                  </Text>
                </View>
              )}
